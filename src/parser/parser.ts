import type {
  ...
  PassthroughNode, DefineNode, TransitionNode,
  ConditionalNode, PipeNode, PipeStage,
  RenderNode, SwitchNode, SwitchCase,
  ForeachNode,
  MarkdownNode, ShellInlineSpan,
} from './types.js'
...
function parseNodes(
  ...
  while (i < lines.length) {
    ...
    const LABEL_AS_DIRECTIVES = new Set(['call'])
